...
<br></br>
                ...
                <h5 className="define-asp"> Creating a Family Report is a quick and easy way to visually map out your children’s progress and level of achievement.  The report will give you a simple way to decide on your priorities as a parent and decide which activities that you may want to keep, stop or start.</h5>

<br></br>
                <h4 className="asp-subtitle">Your assessment</h4>
                <h5 className="define-asp">To complete the Family Report all you have to do is rank each child for the assessment categories that fit your Family Plan.  You can repeat the assessment as often as you want - the Family Report will update each time you make a change.</h5>
...
<br></br>
               ...
               <h5 className="define-asp">The life categories included are: </h5>
               <div id="cats">
               ...
               <h5 className="define-asp">Ignore any category that is not part of your Family Plan for that child - these are normally categories that you don’t care about.
</h5>

               <br></br>

               <h4 className="asp-subtitle">Family Report</h4>
               <h5 className="define-asp">The Family Report is created from your achievement and progress rankings.  Each quadrant represents a range of scores:
</h5>
                <img id="quadrant" src={QuadFinales} />
                <br></br>
                <h5 className="asp-subtitle">How to use the report:</h5>
               <h5 className="define-asp">Think of the report as a simple way to view different aspects of your child’s life.  </h5>
               <div id="defining-asp">
...
<br></br>
               ...
               <h5 className="define-asp"> Time for all of us is precious.  The report should help you decide on your priorities including those activities that you may want to keep, stop or start:  </h5>
               <div id="defining-asp">
