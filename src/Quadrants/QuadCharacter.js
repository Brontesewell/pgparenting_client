    ...
    render() {
        ...
        return (
          <div>
                ...
                <div class="block two">2 { this.state.character_2.map(kid => <h6 id="character2">{kid.name}</h6>)}</div>
                <div class="block four">4 { this.state.character_4.map(kid => <h6 id="character4">{kid.name}</h6>)}</div>
                <p id="bad-progress">Bad Progress ←</p>
                <div id="inside">  </div>
                <div id="side">  </div>
                <div class="block one">1 { this.state.character_1.map(kid => <h6 id="character1">{kid.name}</h6>)}</div>
                <div class="block three">3 { this.state.character_3.map(kid => <h6 id="character3">{kid.name}</h6>)}</div>
